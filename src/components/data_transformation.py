...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            target_feature_train_df=[target_column_name]

            input_feature_test_df=test_df.drop(columns=[target_column_name],axis=1)
            target_feature_test_df=[target_column_name]

            logging.info(
                f"Applying prprocessing object on training dataframe and testing dataframe."
